...
**② 권리금이 확정 현금처럼 취급됩니다 — ⚠️ 낙관적 방향**

`additional_fund_needed`는 총액만 보므로 **금액 자체는 맞습니다.**
문제는 확실성입니다. 온보딩 도움말에도 이렇게 안내하고 있습니다.

> 권리금은 새 임차인이 나타나야 받는 돈이라 확정된 게 아니에요.

그런데 백엔드는 이 값을 통장 잔고와 동일하게 봅니다.
**권리금을 못 받으면 자금 계획이 그만큼 어긋나는데, 그 위험이 결과에 드러나지 않습니다.**
...
| ② 권리금을 현금과 동일 취급 | 자금이 **덜** 필요하다고 나올 수 있음 | **낙관 위험** |

서로 상쇄되지 않습니다. 권리금을 크게 잡은 사용자일수록 ②의 영향이 커지므로,
**"이만하면 되겠다"고 판단할 위험이 있습니다.** 실사용 전에 ②를 먼저 해결하는 것을 권합니다.
